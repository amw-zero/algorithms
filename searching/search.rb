...
#   call binary_search on the subarray from index 0 to the middle
#   index (all lower numbers)
# If it isn't, and the elemnt is greater than the middle element,
#   call binary_search on the subarray from the middle index to
#   the end of the array (all higher numbers)
